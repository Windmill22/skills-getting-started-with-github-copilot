...
activities = {
    ...
    "Basketball Team": {
        "description": "Competitive basketball with weekly games and tournaments",
    ...
    "Tennis Club": {
        ...
        "max_participants": 10,
        "participants": ["casey@mergington.edu", "jordan@mergington.edu"]
    },
    "Art Studio": {
    ...
    "Science Club": {
        "description": "Explore experiments, research, and STEM projects",
